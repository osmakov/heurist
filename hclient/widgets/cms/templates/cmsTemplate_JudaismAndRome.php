...
*/
    ...
    ?>
        <div class="ent_wrapper heurist-website selectmenu-parent">
            ...
            if (!$edit_OldEditor){
                ...
                }elseif($system->getUserId() == 0 && $show_login_button){
    ...
    ?>
        ...
        <div class="ent_wrapper heurist-website selectmenu-parent">
            <div id="main-header" class="ent_header ui-heurist-header2" <?php print $image_banner ? 'style="background-image:url(\'' . $image_banner . '\') !important;background-repeat: repeat-x !important;"' : '' ?>>
            ...
            <div class="ent_content_full  ui-heurist-bg-light" id="main-content-container" style="top:152px;<?php echo $is_page_footer_fixed ? 'bottom:' . $page_footer_height . 'px;' : '';?>padding: 5px;">
                <div id="sidebar">
                    ...
                    <a href="5929">Architecture</a>
                    <a href="5930">Frescoes/Wall Paintings</a>
                    <a href="5931">Inscriptions</a>
                    <a href="5932">Mosaics</a>
                    <a href="5933">Numismatic Items</a>
                    <a href="5934">Papyrii</a>
